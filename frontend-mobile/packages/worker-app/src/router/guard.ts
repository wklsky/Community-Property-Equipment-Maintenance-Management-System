 ...
 * @FilePath: frontend-mobile/packages/worker-app/src/router/guard.ts
 * @Description: 维修工 App 的守卫装配，将本 App 的身份信息注入共享守卫
 */
...
/**
 * 只把维修工 App 的身份注入共享守卫，不再复制一份拦截逻辑。
 * 未来若维修工端需要额外的准入规则（如在岗状态校验），在此处追加即可
 */
