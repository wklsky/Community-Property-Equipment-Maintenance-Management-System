<template>
  <view class="page">
    ...
    <view class="panel">
      <view class="menu-item" @click="go('/pages/address/list')">
 ...
 * @FilePath: frontend-mobile/packages/owner-app/src/pages/mine/index.vue
 * @Description: 业主端个人中心，聚合非 tabBar 业务入口并提供退出登录
 */
